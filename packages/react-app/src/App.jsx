...
function App(props) {
  ...
  const purpose = useContractReader(readContracts,"IpDid", "purpose")

  //📟 Listen for broadcast events
  const setPurposeEvents = useEventListener(readContracts, "IpDid", "SetPurpose", localProvider, 1);
    ...
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Menu style={{ textAlign:"center" }} selectedKeys={[route]} mode="horizontal">
          <Menu.Item key="/">
            <Link onClick={()=>{setRoute("/")}} to="/">IpDid</Link>
          </Menu.Item>
          <Menu.Item key="/hints">
